...
export default function ShabuajihiLanding() {
  ...
  const menu = [
    { id: 1, name: "Shabu Classic", desc: "Thinly sliced beef, house broth, seasonal veg.", price: "Rp 85.000", img: "https://images.unsplash.com/photo-1604908177522-1d3996a1f0f3" },
    { id: 2, name: "Seafood Shabu", desc: "Shrimp, squid, and fish balls", price: "Rp 95.000", img: "https://images.unsplash.com/photo-1543353071-087092ec393d" },
    { id: 3, name: "Vegetarian", desc: "Tofu, mushrooms, seasonal greens", price: "Rp 70.000", img: "https://images.unsplash.com/photo-1504674900247-0877df9cc836" },
    ...
    { id: 5, name: "Family Hotpot", desc: "Shareable pot for 3-4 people", price: "Rp 240.000", img: "https://images.unsplash.com/photo-1604908177522-1d3996a1f0f3" },
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 items-center relative z-10">
          ...
          <div className="flex items-center justify-center">
            <div ref={heroImgRef} className="rounded-xl overflow-hidden shadow-2xl max-w-md w-full" style={{ border: `8px solid rgba(255,255,255,0.06)` }}>
              <img src="https://images.unsplash.com/photo-1604908177522-1d3996a1f0f3?q=80&w=1200&auto=format&fit=crop&ixlib=rb-4.0.3&s=placeholder" alt="Shabu bowl" className="w-full h-96 object-cover" />
            </div>
          </div>
        </div>
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 gap-4">
            {Array.from({ length: 9 }).map((_, i) => (
              <div key={i} className="rounded-xl overflow-hidden shadow-md h-44">
                <img src={`https://images.unsplash.com/photo-1541542684-3c3a6a9d9c2b?q=80&w=800&auto=format&fit=crop`} alt={`gallery-${i}`} className="w-full h-full object-cover" />
              </div>
            ))}
          </div>
        </div>
